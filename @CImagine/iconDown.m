...
%         obj.loadFiles;
      ...
      case 'Register'
        ...
        sRegPath = [obj.sBasePath, filesep, 'registration'];
  ...
  case 0
    ...
    switch(obj.SMenu(iInd).Name)
      ...
      case 'explorer'
        if isempty(obj.hExplorer) || ~ishandle(obj.hExplorer)
          obj.hExplorer = CExplorer(obj);
          addlistener(obj.hExplorer, 'update', @obj.draw);
        end
